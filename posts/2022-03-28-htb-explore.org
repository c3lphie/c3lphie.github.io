...
*Spoiler ALERT* it doesn't... But google quickly tells us about [[https://nvd.nist.gov/vuln/detail/CVE-2019-6447][CVE-2019-6447]], which basically a backdoor in a File manager (ES File Explorer) for android.
* Exploitation
